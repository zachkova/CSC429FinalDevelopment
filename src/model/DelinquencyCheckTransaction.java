...
public class DelinquencyCheckTransaction implements IView, IModel, ISlideShow {
    ...
    private void searchRentals(Properties z) throws InvalidPrimaryKeyException {
        rc = new RentalCollection();
        rc.getBannerId((String)z.getProperty("barcode"));
        createAndShowRentBook();
        bCode = z.getProperty("barcode");
